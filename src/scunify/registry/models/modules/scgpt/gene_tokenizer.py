...
class GeneVocab(Vocab):
    ...
    def __init__(
        self,
        gene_list_or_vocab: list[str] | Vocab,
    ...
    @classmethod
    def from_file(cls, file_path: Path | str) -> Self:
        """
    ...
    def save_pickle(self, file_path: Path | str) -> None:
        """
...
def _build_default_gene_vocab(
    ...
    save_vocab_to: Path | str | None = None,
) -> GeneVocab:
    """
