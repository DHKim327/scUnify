...
# Lazy imports
__all__ = ["resolve_inferencer", "ScFoundationInferencer", "ScGPTInferencer", "UCEInferencer", "GeneformerInferencer", "NicheformerInferencer"]
...
_ALIAS = {
    ...
    "nicheformer": "NicheformerInferencer",
}
...
def __getattr__(name):
    ...
    if name == "ScFoundationInferencer":
        ...
        return _IMPORTED[name]
    elif name == "NicheformerInferencer":
        if name not in _IMPORTED:
            from ._nicheformer_inferencer import NicheformerInferencer
            _IMPORTED[name] = NicheformerInferencer
        return _IMPORTED[name]
